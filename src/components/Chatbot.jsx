...
if(user && user.role=='patient'){
    ...
    if (lowerMsg.includes('appointment') || lowerMsg.includes('appointments')) {
  ...
  return (
    <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl border border-gray-200 p-4 h-[500px] flex flex-col">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-500 to-teal-400 text-white p-3 rounded-t-xl flex items-center justify-between">
      ...
      {/* Chat Area */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-gray-100">
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={handleSend}
            className="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 transition duration-200 disabled:bg-blue-300"
            disabled={!input.trim()}
          >
            Send
          </button>
